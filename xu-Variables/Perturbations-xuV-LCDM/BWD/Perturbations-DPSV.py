...
Combination of the SFDM and Cosmological Constant model equations. Perturbation equations with T<<Tc.
...
Comment: This code evolves the system BACKWARDS in time.
